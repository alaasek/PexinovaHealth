...
const NovaSuccessScreen: React.FC<Props> = ({ navigation }) => {
    // Game Context
    ...
    const handleContinue = () => {
        ...
        navigation.navigate('Home', { triggerLaser: true } as any);
    };

    // Helper to get position based on index to match visual consistency
    const getAlienStyle = (index: number) => {
        const positionIndex = index % 3;
        if (positionIndex === 0) return { top: 40, left: width * 0.2 };
        if (positionIndex === 1) return { top: 80, right: width * 0.2 };
        return { top: 150, right: width * 0.1 };
    };
...
const styles = StyleSheet.create({
    ...
    scoreText: { fontSize: 16, color: '#FFFFFF', fontWeight: '400', fontFamily: 'Poppins-Regular' },
    scoreValue: { fontSize: 16, color: '#FFFFFF', fontWeight: 'bold', fontFamily: 'Poppins-Bold' },
    ...
    planet: { width: width * 0.55, height: width * 0.55, zIndex: 1 },
    ...
    modalCard: {
        backgroundColor: 'rgba(26, 18, 50, 0.4)', // Much more transparent
        width: width * 0.85,
        // ...
        padding: 30,
        borderRadius: 24,
    ...
    greetingTitle: { fontSize: 14, color: '#E0E0E0', marginBottom: 4, fontFamily: 'Poppins-Regular' },
    greetingSubtitle: { fontSize: 15, fontWeight: '600', color: '#FFFFFF', marginBottom: 4, fontFamily: 'Poppins-SemiBold' },
    greetingBody: { fontSize: 12, color: '#B0B0C0', fontFamily: 'Poppins-Regular' },
...
export default NovaSuccessScreen;
